...
function readDesktopPreferences(): DesktopPreferences {
  ...
  try {
    ...
    const normalized: DesktopPreferences = {
      ...
      surfaceOpacity: numericPreference(saved.surfaceOpacity, 86, 50, 100),
